    ...
    <footer className='footer'>
      <div className="footer-top">
        <div className="footer-brand">
          <Link to="/"><img src={logo} alt="CryptoPlace" className="footer-logo" /></Link>
          <p className="footer-tagline">Track crypto prices, charts & market data in real-time.</p>
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2026 CryptoPlace. All rights reserved.</p>
